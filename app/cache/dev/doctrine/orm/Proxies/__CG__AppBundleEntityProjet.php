...
class Projet extends \AppBundle\Entity\Projet implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'categorie', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'deadline', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'datecrea', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'idchef', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'iddev'];
        }
    ...
    public function getIdchef()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdchef', []);
