...
class Discussion extends \AppBundle\Entity\Discussion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Discussion' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Discussion' . "\0" . 'datecreation', '' . "\0" . 'AppBundle\\Entity\\Discussion' . "\0" . 'etat', '' . "\0" . 'AppBundle\\Entity\\Discussion' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Discussion' . "\0" . 'idproj'];
        }
