...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'coollab', 'user' => 'root', 'password' => 'password', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EntityManager56c71850cf969_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager56c71850cf969_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_56c71850cf969.php');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager56c71850cf969_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($d, $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_53d066dfa31340764a5ebbb18854daedd4740b2eef3768cbdfbf508efaa765e8');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\Firewall\WsseListener A AppBundle\Security\Firewall\WsseListener instance.
     */
    protected function getSecurity_Authentication_Listener_Wsse_WsseSecuredService()
    {
        return $this->services['security.authentication.listener.wsse.wsse_secured'] = new \AppBundle\Security\Firewall\WsseListener($this->get('security.context'), $this->get('security.authentication.manager'), $this->get('monolog.logger.wsse'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\Authentication\Provider\WsseProvider A AppBundle\Security\Authentication\Provider\WsseProvider instance.
     */
    protected function getSecurity_Authentication_Provider_Wsse_WsseSecuredService()
    {
        return $this->services['security.authentication.provider.wsse.wsse_secured'] = new \AppBundle\Security\Authentication\Provider\WsseProvider($this->get('fos_user.user_provider.username_email'), (__DIR__.'/security/nonces'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.wsse_secured' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/.*'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
    ...
    {
        return $this->services['security.firewall.map.context.wsse_secured'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.authentication.listener.wsse.wsse_secured'), 2 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($this->get('security.token_storage'), $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'wsse_secured', NULL, NULL, NULL, $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE), true));
    }
    ...
    {
        return $this->services['wsse.security.authentication.listener'] = new \AppBundle\Security\Firewall\WsseListener($this->get('security.context'), $this->get('security.authentication.manager'), $this->get('monolog.logger.wsse'));
    }
    ...
    {
        return $this->services['wsse.security.authentication.provider'] = new \AppBundle\Security\Authentication\Provider\WsseProvider('', (__DIR__.'/security/nonces'));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_56c71850cf969.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager56c71850cf969_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
