...
class Message extends \AppBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'message', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'dateenvoi', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'iddisc', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'iddev'];
        }
    ...
    public function setIddisc(\AppBundle\Entity\Discussion $iddisc)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIddisc', [$iddisc]);

        return parent::setIddisc($iddisc);
    }
    ...
    public function setIddev(\AppBundle\Entity\Developpeur $iddev)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIddev', [$iddev]);

        return parent::setIddev($iddev);
    }
