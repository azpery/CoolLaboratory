 ...
 */
class Rss extends \AppBundle\Entity\Rss implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Rss' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Rss' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Rss' . "\0" . 'pubdate', '' . "\0" . 'AppBundle\\Entity\\Rss' . "\0" . 'link', '' . "\0" . 'AppBundle\\Entity\\Rss' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Rss' . "\0" . 'idproj'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Rss $proxy) {
